    ...
    unsigned long cell_index)
{
  ...
  neighbor_0_index = h_ca_fly_get_relative_cell_index
    (system, cell_index, 0);
  neighbor_1_index = h_ca_fly_get_relative_cell_index
    (system, cell_index, 1);
  neighbor_2_index = h_ca_fly_get_relative_cell_index
    (system, cell_index, 2);
  neighbor_3_index = h_ca_fly_get_relative_cell_index
    (system, cell_index, 3);
  neighbor_4_index = h_ca_fly_get_relative_cell_index
    (system, cell_index, 4);
  neighbor_5_index = h_ca_fly_get_relative_cell_index
    (system, cell_index, 5);
...
void h_ca_fly_init_systemey(h_ca_systemey_t *systemey, void *name_object)
{
  h_ca_systemey_init(systemey, name_object,
      h_ca_fly_calculate_new_cell_state, H_CA_NO_CREATE_CONTEXT_FUNCTION,
      H_CA_NO_DESTROY_CONTEXT_FUNCTION, H_CA_NO_END_TIME_STEP_FUNCTION,
      h_ca_system_get_cell_color_binary, h_ca_fly_get_relative_cell_index,
